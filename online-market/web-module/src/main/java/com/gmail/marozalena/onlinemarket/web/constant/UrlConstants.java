...
public class UrlConstants {
    ...
    public static final String URL_TO_CREATE_REVIEW_PAGE = "/reviews/new";
    ...
    public static final String URL_TO_ORDERS_PAGE_FOR_SALE_USER = "/private/orders";
    public static final String URL_TO_ORDER_PAGE = "/private/orders/{id}";
