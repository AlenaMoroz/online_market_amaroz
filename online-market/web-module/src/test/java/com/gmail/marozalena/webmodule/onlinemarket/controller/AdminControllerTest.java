package com.gmail.marozalena.webmodule.onlinemarket.controller;

import com.gmail.marozalena.onlinemarket.ReviewService;
import com.gmail.marozalena.onlinemarket.UserService;
import com.gmail.marozalena.onlinemarket.controller.AdminController;
...
public class AdminControllerTest {
    ...
    private List<UserDTO> users = asList(new UserDTO("Name1", "Name2", "Name3", "Email", new RoleDTO(2L, "Sale User")),
            new UserDTO("Name1.1", "Name2.1", "Name3.1", "Email1", new RoleDTO(3L, "Customer User")));

    private List<ReviewDTO> reviews = asList(new ReviewDTO(new UserDTO("Surname", "Name", "Patronymic", "Email", null),
                    "Review", new Timestamp(new Date().getTime()), true),
            new ReviewDTO(new UserDTO("Surname1", "Name1", "Patronymic1", "Email1", null),
                    "Review1", new Timestamp(new Date().getTime()), false));

    @Before
    public void init() {
        adminController = new AdminController(userService, reviewService);
